...
void AWeapon::ThrowWeapon()
{
	...
	bFalling = true;
	GetWorldTimerManager().SetTimer(ThrowWeaponTimer,
		this,
		&AWeapon::StopFalling,
		ThrowWeaponTime);
	EnableGlowMaterial();
	SetSlotIndex(0); // patch
}
...
{
	checkf(Ammo + Amount <= MagCap, TEXT("Exceeds magazine capacity!"));
	Ammo += Amount;
}
...
void AWeapon::OnConstruction(const FTransform& Transform)
{
	...
	if (WeaponTableObject)
	{
		...
		if (WeaponDataRow)
		{
			...
			MagCap = WeaponDataRow->MagazineCapacity;
