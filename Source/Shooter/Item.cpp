...
void AItem::ItemInterp(float DeltaTime)
{
	...
	{
		// Elapsed time since we started ItemInterppTimer
		...
		// Vector from Item to Camera target, X & Y zeroed out
		...
		// Set X & Y of item location to interp values
